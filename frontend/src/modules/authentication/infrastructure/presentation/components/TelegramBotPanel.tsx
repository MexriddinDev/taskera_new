...
export const TelegramBotPanel: React.FC = () => {
  ...
  return (
    <aside className="w-full max-w-[280px] lg:w-[240px] p-4 flex flex-col bg-white dark:bg-slate-900/70 rounded-3xl shadow-xl dark:shadow-black/30 border border-slate-200 dark:border-slate-700/70 backdrop-blur-sm transition-all">
